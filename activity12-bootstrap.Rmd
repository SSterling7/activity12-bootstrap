...
```{r}
ggplot(gss, mapping = aes(x=educ, y = ..density..)) +
  geom_histogram() +
  geom_density()
```


**Response**: left skewed, two peaks
...
**Response**: nearly 14 years of education
